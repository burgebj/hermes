...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      typographyDesc: 'Adjust font sizes for the chat interface and UI elements.',
      baseFontSize: 'Base Font Size',
      baseFontSizeDesc: 'Controls the base font size for UI elements (sidebar, menus, buttons).',
      messageFontSize: 'Message Text Size',
      messageFontSizeDesc: 'Font size for chat messages and code blocks.',
      densityTitle: 'UI Density',
      densityDesc: 'Adjust spacing and padding throughout the interface.',
      compact: 'Compact',
      compactDesc: 'Tighter spacing, more content visible.',
      defaultDensity: 'Default',
      defaultDesc: 'Balanced spacing.',
      comfortable: 'Comfortable',
      comfortableDesc: 'Relaxed spacing, easier on the eyes.'
    },
