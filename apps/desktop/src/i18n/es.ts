...
export const es = defineLocale({
  ...
  intro: {
    neutralCopy: [
      {
        headline: 'Tu espacio de trabajo, a un mensaje de distancia.',
        body: 'Busca en el repositorio, edita archivos, ejecuta pruebas y abre PRs. Cuéntame el objetivo y me encargo de las partes mecánicas.'
      }
    ]
  },
  ...
  composer: {
    ...
    sendQueuedNext: 'Enviar turno en cola después',
  ...
  modelPicker: {
    ...
    persistGlobalSession: 'Persistir globalmente (si no, solo esta sesión)',
  ...
  assistant: {
    thread: {
      ...
      stop: 'Detener',
      editableCheckpoint: 'Checkpoint editable',
