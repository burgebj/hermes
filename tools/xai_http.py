...
def get_env_value(name: str, default=None):
    ...
    Resolve :func:`hermes_cli.config.get_env_value` at call time instead of
    caching it at module import. Test workers and profile switches can reload
    ``hermes_cli.config``; a stale function reference would keep reading the
    old module globals and miss patched or newly selected dotenv state.
    """
    try:
