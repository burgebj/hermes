...
Hermes Agent умеет многое — CLI-ассистент, бот для Telegram/Discord, автоматизация задач, обучение с подкреплением и не только. Эта страница помогает понять, с чего начать и что читать дальше в зависимости от вашего уровня и того, чего вы хотите добиться.
...
:::tip
Передавайте файлы прямо в разговор через файлы контекста. Hermes Agent умеет читать, редактировать и запускать код в ваших проектах.
:::
...
Используйте обучение с подкреплением, чтобы донастроить поведение модели с помощью встроенного RL-пайплайна Hermes Agent.
...
Интегрируйте Hermes Agent в собственные Python-приложения из кода.
