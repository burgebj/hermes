...
| [**pptx-author**](/docs/user-guide/skills/optional/finance/finance-pptx-author) | Собирает презентации PowerPoint без GUI через `python-pptx`. Пара к `excel-author` для презентаций, где каждая цифра должна быть привязана к ячейке рабочей книги. Подходит для pitch deck, материалов для инвестиционного комитета и заметок по отчётности. |
