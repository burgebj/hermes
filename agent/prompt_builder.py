...
KANBAN_GUIDANCE = (
    ...
    "6. **Log work to vault memory.** After completing, write a summary of your "
    "findings/actions to the vault using `memory(action='add', target='memory', "
    "content='...')` so the dream cycle and future sessions can recall your work. "
    "Include: what you did, key findings, files changed, decisions made.\n"
