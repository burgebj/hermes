"""FallbackMixin -- provider fallback and recovery methods extracted from AIAgent.

Encapsulates fallback activation, credential pool recovery, primary runtime
restore, transport recovery, and Anthropic credential refresh.
...
class FallbackMixin:
    """Mixin providing provider fallback and recovery methods for AIAgent.
