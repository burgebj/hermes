...
export const uk: Translations = {
  common: {
    ...
    pluginCrashed:
      "Цьому плагіну не вдалося виконати рендеринг. Якщо ви щойно оновили Hermes, перезберіть веб-ресурси (npm run build) і перезавантажте сторінку. Відкрийте консоль браузера, щоб побачити деталі.",
  },
