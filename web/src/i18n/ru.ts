...
export const ru: Translations = {
  common: {
    ...
    pluginCrashed:
      "Этому плагину не удалось выполнить отрисовку. Если вы только что обновили Hermes, пересоберите веб-ресурсы (npm run build) и обновите страницу. Откройте консоль браузера для подробностей.",
  },
