...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("route", "Show routing guidance for directing work to an agent", "Info",
               gateway_only=True, args_hint="@agent [task]"),
    CommandDef("checklist", "Create an emulated Telegram checklist with buttons", "Session",
               gateway_only=True, aliases=("cl",), args_hint="[title]"),
    CommandDef("say", "Send a text-to-speech request through the voice lane", "Session",
               gateway_only=True, args_hint="<text>"),
    CommandDef("tts", "Alias for /say", "Session",
               gateway_only=True, args_hint="<text>"),
    CommandDef("voice_status", "Show Telegram voice/TTS workspace status", "Info",
               gateway_only=True, aliases=("vs",)),
