...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("morning", "Generate the morning brief with live OpenWhoop context", "Session",
               gateway_only=True),
    CommandDef("midday", "Generate the midday brief with pacing/recovery context", "Session",
               gateway_only=True),
    CommandDef("night", "Generate the night brief with shutdown/tomorrow-readiness context", "Session",
               gateway_only=True),
