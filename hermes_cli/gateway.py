...
# its interactive_setup lives there, dispatched via the registry
# setup_fn path in _configure_platform().
...
def _builtin_setup_fn(key: str):
    ...
    return {
        ...
        # signal moved into the plugin: setup_fn is registered by
        # plugins/platforms/signal/adapter.py::register() and dispatched
        # via the plugin path in _configure_platform().
